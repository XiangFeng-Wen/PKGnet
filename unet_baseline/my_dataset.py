...
class DriveDataset(Dataset):
    def __init__(self, root: str, train: bool, transforms=None):
        ...
        mask_names = [i for i in os.listdir(os.path.join(data_root, "all_manual")) if i.endswith(".png")]
        self.mask_list = [os.path.join(data_root, "all_manual", i.split(".")[0]+".png") for i in img_names]
    ...
    def __getitem__(self, idx):
        ...
        img = cv2.imdecode(np.fromfile(self.img_list[idx], dtype=np.uint8),cv2.IMREAD_GRAYSCALE)
